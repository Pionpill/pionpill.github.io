...
在资源包或行为包中，我们新建一个名为 texts 的文件夹(需要对哪个做国际化就在哪个包下新建，一般两个包都需要添加)，假设我们需要支持中文和英文两种语言。则需要创建如下结构(以行为包为例):
...
一些文档，API 链接如下:
- 官方JSON文档(英): [https://learn.microsoft.com/en-us/minecraft/creator/reference/]()
